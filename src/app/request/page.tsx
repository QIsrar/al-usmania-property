          ...
          <AnimatedSection delay={0.3}>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2.5 bg-stone-50 border-2 border-stone-400 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-brand-500/30 focus:border-brand-500"
              ...
              <div>
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    className="flex-1 px-4 py-2.5 bg-stone-50 border-2 border-stone-400 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-brand-500/30 focus:border-brand-500"
                    placeholder="e.g., 5"
                  />
                  <select
            ...
            <div>
              ...
              <textarea
                ...
                rows={4}
                className="w-full px-4 py-2.5 bg-stone-50 border-2 border-stone-400 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-brand-500/30 focus:border-brand-500 resize-none"

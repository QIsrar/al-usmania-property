...
export function WhatsAppFloat() {
  return (
    ...
    >
      ...
      {/* Tooltip */}
      <span className="absolute right-full mr-3 px-3 py-1.5 bg-stone-800 text-white text-sm rounded-lg whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none">
        Chat with us
      </span>

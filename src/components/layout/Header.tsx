        ...
        <div className="flex items-center justify-between h-16 lg:h-20">
              ...
              <Link
                ...
                className={cn(
                  ...
                  pathname === link.href
                    ...
                    : "text-stone-600 hover:text-brand-600 hover:bg-stone-100"
                )}
              >
                {link.label}
              </Link>
          ...
          <div className="flex items-center gap-3">
            <a
              ...
              className="hidden sm:inline-flex items-center gap-2 px-4 py-2.5 bg-brand-500 text-white text-sm font-medium rounded-lg hover:bg-brand-600 transition-colors duration-200 shadow-sm"
            >
        ...
        <div className="lg:hidden bg-white border-t border-stone-100 animate-fade-in">
          <nav className="max-w-7xl mx-auto px-4 py-4 space-y-1">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-2 px-4 py-3 mt-2 bg-brand-500 text-white font-medium rounded-lg"
            >
            ...
            <div className="px-4 pt-3 border-t border-stone-100">
              <a
                href={`tel:${BUSINESS.phone.primaryClean}`}

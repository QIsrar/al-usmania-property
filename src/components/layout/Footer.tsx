          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <div className="text-xs text-stone-600 flex flex-wrap items-center gap-1.5">
              ...
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-stone-800/90 border border-brand-500/30 hover:border-brand-500 hover:bg-stone-800 hover:shadow-[0_0_20px_rgba(217,119,6,0.5)] hover:-translate-y-1 transition-all duration-500 group relative overflow-hidden animate-pulse hover:animate-none"
              >
                <span className="absolute inset-0 bg-gradient-to-r from-brand-500/20 to-amber-500/20 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></span>
                <span className="relative font-bold tracking-widest text-xs sm:text-sm uppercase bg-gradient-to-r from-brand-300 via-amber-400 to-yellow-500 bg-[length:200%_auto] animate-gradient bg-clip-text text-transparent group-hover:from-brand-200 group-hover:via-amber-300 group-hover:to-yellow-400 transition-all duration-500 drop-shadow-md">
                  QI Tyrix
                </span>
                <svg className="relative w-4 h-4 text-amber-500/70 group-hover:text-amber-400 group-hover:translate-x-1 group-hover:-translate-y-1 transition-all duration-300" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
